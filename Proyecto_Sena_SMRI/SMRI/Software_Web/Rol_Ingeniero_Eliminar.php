...
<html lang="es">
    ...
    <center><h1>Eliminar Un Empleado</h1></center>
    <nav>
        <ul class="nav justify-content-center">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="Rol_Ingeniero_Ingresar.html">Ingresar</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="Rol_Ingeniero_Eliminar.html">Eliminar</a>
                </li>
            </ul>
    </nav>
    <body>
