...
<html lang="es">
    <head>
        ...
        <div class="encabezado">
            <img class="rol" src="Imagenes/rol_supervisor.jpg" alt=""><h1 class="titulo">Supervisor</h1><button type="submit" class="btn btn-primary">Salir</button>
        </div>
    </head>
    ...
    <nav>
        <ul class="nav justify-content-center">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="Rol_Supervisor_Ingresar.html">Ingresar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Rol_Supervisor_Consultar.html">Consultar</a>
                </li>
            </ul>
    </nav>
    <body>
